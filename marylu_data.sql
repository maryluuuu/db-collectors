...
insert into `disco`(ID, titolo_disco, anno_uscita, barcode, durata_totale, ID_etichetta, ID_genere) values
...
(1,'The Wall',1979,0000000012,null,1, 1),
...
-- della collezione 'Pink Floyd Music' di bob
(2, 'The Dark Side of the Moon', 1973, null, null, 1, 3),
...
(3, 'Abbey Road', 1969, null, null, 2, 2),
...
-- della Sony Music Entertainment, genere Progressive Rock,
-- della collezione 'I miei preferiti' di alice
-- (4,'The Wall',1979,0000000013,null, 1, 1),
(4, "Sgt. Pepper's Lonely Hearts Club Band ", 1967, 0000000015, null, 4, 4);


-- disco 'Abbey Road' del 1969, non esiste barctracciaode, durata tot(Come Together),
-- della Sony Music Entertainment, genere Art Rock,
-- della collezione 'I miei preferiti' di bob
-- (5, 'Abbey Road', 1969, null, null,2, 2);
